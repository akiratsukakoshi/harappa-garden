...
- 段階: **test**(本 SKILL の骨格完成。最初の業務 1 つに当てて active へ)
- 次の検証: 実際の業務 1 件で Mode 1〜5 を一巡し、重い Mode / 削れる Mode を見極める
- active 条件: 1 業務の区画化が初回完走し、本 SKILL の手順が「議論を分類に落とせた」ことを確認
