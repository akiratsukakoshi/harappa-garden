...
| 土壌-people/clients | [soil/people/clients/](soil/people/clients/) | 🌱 | **S48 着手**:MTI の林愛也・中野絵里奈(Gmail 署名から確実に正本化)。Plaud 話者でなくメール署名が実名ソース |
...
| 土壌-clients ← **NEW** | [soil/clients/](soil/clients/) | 🌱 | **S48 新設**:クライアント企業正本(2層 = 企業→案件、a〜f+メール+finance を案件台帳に一望)。[README](soil/clients/README.md) が型。**MTI が第1号縦通し**(Plaud打合せ + Gmailメール + 見積/請求実物 + 担当者 + finance)。世話役 = [client_steward](plots/client_steward/SKILL.md) |
...
| 区画 (plots) | [garden/plots/](plots/) | 🌱 | **第1号 daily-pilot(S19)+ 第2号 shift_manager(S21)+ メタ区画 plot_gardener(S33)+ 第3号 expense_processor(S35)+ 第4号 invoice_processor(S41)+ 第5号 field_assistant(S42)+ 第6号 sns_manager(S45)+ 第7号 finance(S47、3スキル統合)**:いずれも CHARTER 継承型 |
